        ...
        <div className="w-full flex flex-col-reverse sm:flex-row">
          <div className="w-full md:w-[50%] md:h-full flex items-center mt-100">
            <LazyMotion features={domAnimation} strict>
              ...
              >
                <span className="text-primary-400" style={{ fontSize: '1.2em', fontWeight: '900', color: 'rgba(255,255,255,0.85)' }}>{introduction.text[0]}</span>
                <span className="text-primary-500" style={{ fontSize: '0.95em', fontWeight: '500', color: 'rgba(255,255,255,0.85)'}}>{introduction.text[1]}</span>
                <span className="text-primary-500" style={{ fontSize: '0.95em', fontWeight: '500', color: 'rgba(255,255,255,0.85)'}}>{introduction.text[2]}</span>
                <span className="text-primary-500" style={{ fontSize: '0.95em', fontWeight: '500', color: 'rgba(255,255,255,0.85)'}}>{introduction.text[3]}</span>
              </m.p>
            </LazyMotion>
          </div>
