...
import { bl33hIcon as v1ihIcon, menu, close } from "../../assets";
  ...
  return (
    ...
    >
      <div className="w-full flex justify-between items-center max-w-7x1 mx-auto">
        ...
        >
          <img src={v1ihIcon} alt={v1ihIcon} className="w-18 h-9 object-contain" />
          <p className="text-white text-[18px] font-bold cursor-pointer flex">
          </p>
        </Link>
        <ul className="list-none hidden sm:flex flex-row gap-10"  style={{ color: 'whitesmoke' }}>
          {navLinks.map((link) => {
            return (
              <li
                key={link.id}
