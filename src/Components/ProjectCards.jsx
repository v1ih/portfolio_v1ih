	...
	return (
		...
		>
			...
			>
				...
				<div className="mt-3">
					<h3 className="text-white font-bold text-2xl" style={{ color: 'rgba(255,255,255,0.85)' }}>{name}</h3>
					<p className="mt-2 text-secondary text-[14px] leading-snug" style={{ color: 'rgba(255,255,255,0.85)' }}>
						{description}
					</p>
				</div>
